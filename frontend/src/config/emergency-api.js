...
const EMERGENCY_BACKEND_URL = process.env.REACT_APP_API_URL || 'https://mental-health-companion-backend-wheat.vercel.app/api';
...
export const EMERGENCY_API_ENDPOINTS = {
  login: `${EMERGENCY_BACKEND_URL}/auth/login`,
  register: `${EMERGENCY_BACKEND_URL}/auth/register`,
  me: `${EMERGENCY_BACKEND_URL}/auth/me`,
};
